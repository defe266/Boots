<?php
	...
	function cookieConsent_enqueue_scripts_styles()
	{
		...
		$content = sprintf( __( 'This site uses cookies to improve the services offered. If you continue with this browsing session, we consider that you accept the use. <a href="%s">Learn more</a>', 'wpboots' ), get_the_permalink( get_option("wpboots_pageCookies") ) );
