...
function toolbox_setup() {
	 ...
	 * to change 'wpboots' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'wpboots', get_template_directory() . '/languages' );
...
function toolbox_widgets_init() {
	...
	register_sidebar( array(
		...
		'id' => 'sidebar-2',
		'description' => __( 'An optional second sidebar area', 'wpboots' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => "</aside>",
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
 ...
 * @since Toolbox 1.2
 */
function toolbox_content_nav( $nav_id , $args = null ) {
	global $wp_query;
		...
		<ul class="pager">
			...
			<?php
				...
				if(isset($args)){
					...
					$nextArgs = $nextArgs + $args;
				}


				previous_post_link_plus( $prevArgs );
				next_post_link_plus( $nextArgs );
			?>
				
			<?php //previous_post_link( '<li class="nav-previous previous">%link</li>', '<span class="meta-nav">' . _x( '&larr;', 'Previous post link', 'wpboots' ) . '</span> %title' ); ?>
			<?php //next_post_link( '<li class="nav-next next">%link</li>', '%title <span class="meta-nav">' . _x( '&rarr;', 'Next post link', 'wpboots' ) . '</span>' ); ?>
		</ul>
	...
	<?php elseif ( $wp_query->max_num_pages > 1 && ( is_home() || is_archive() || is_search() ) ) : // navigation links for home, archive, and search pages ?>
		...
		<ul class="pager">
			...
			<li class="nav-previous previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Older posts', 'wpboots' ) ); ?></li>
			<?php endif; ?>
	
			<?php if ( get_previous_posts_link() ) : ?>
			<li class="nav-next next"><?php previous_posts_link( __( 'Newer posts <span class="meta-nav">&rarr;</span>', 'wpboots' ) ); ?></li>
			<?php endif; ?>
		</ul>
		...
		<article id="comment-<?php comment_ID(); ?>" class="comment">
			<footer>
				<div class="comment-author vcard">
					...
					<?php printf( __( '%s <span class="says">says:</span>', 'wpboots' ), sprintf( '<cite class="fn">%s</cite>', get_comment_author_link() ) ); ?>
				</div><!-- .comment-author .vcard -->
				<?php if ( $comment->comment_approved == '0' ) : ?>
					<em><?php _e( 'Your comment is awaiting moderation.', 'wpboots' ); ?></em>
					<br />
				<?php endif; ?>
				...
				<div class="comment-meta commentmetadata">
					...
					<?php
						...
						printf( __( '%1$s at %2$s', 'wpboots' ), get_comment_date(), get_comment_time() ); ?>
					</time></a>
					<?php edit_comment_link( __( '(Edit)', 'wpboots' ), ' ' );
					?>
...
function toolbox_posted_on() {
	printf( __( '<span class="sep">Posted on </span><a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s" pubdate>%4$s</time></a><span class="byline"> <span class="sep"> by </span> <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span></span>', 'wpboots' ),
		esc_url( get_permalink() ),
		esc_attr( get_the_time() ),
		esc_attr( get_the_date( 'c' ) ),
		esc_html( get_the_date() ),
		esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ),
		esc_attr( sprintf( __( 'View all posts by %s', 'wpboots' ), get_the_author() ) ),
...
add_image_size( 'thumb3', 270, 154, true );
add_image_size( 'thumb4', 370, 208, true );
...
add_image_size( 'thumb2', 170, 127, true );
add_image_size( 'thumb3', 270, 202, true );
add_image_size( 'thumb4', 370, 277, true );
add_image_size( 'thumb6', 570, 427, true );
add_image_size( 'thumb12', 1170, 877, true );
